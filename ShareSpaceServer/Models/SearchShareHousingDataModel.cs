...
{
    public class SearchShareHousingDataModel
    {
        ...
        public int MinPricePerMonthOfOne { get; set; }   // -2 is Any. -1 is Deal. [Any, Deal, 500k, 1000k, 3000k, 5000k, 10000k, 40000k]
        public int MaxPricePerMonthOfOne { get; set; }   // -2 is Any. -1 is Deal. [Any, Deal, 500k, 1000k, 3000k, 5000k, 10000k, 40000k]
        ...
        public int NumRoommate { get; set; }    // [1, 5]
        public string RequiredGender { get; set; }      // [Male, Female, Other]
        public string RequiredWorkType { get; set; }    // [Student, Employee]
        public bool[] OtherInfo { get; set; }         // [Any, Allow Smoking, Allow Alcohol, Has Private Key]
    }
}