...
namespace ShareSpaceServer
{
    ...
    public class MyGeoLocation
    {
        ...
        public static MyGeoLocation FromDegrees(double latitude, double longitude)
        {
            MyGeoLocation result = new MyGeoLocation
            {
        ...
        public static MyGeoLocation FromRadians(double latitude, double longitude)
        {
            MyGeoLocation result = new MyGeoLocation
            {
                radLat = latitude,
        ...
        public double DistanceTo(MyGeoLocation location)
        {
        ...
        public MyGeoLocation[] BoundingCoordinates(double distance)
        {
